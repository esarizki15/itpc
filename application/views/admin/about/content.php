	...
	<div class="col-sm-12">
		<div class="page-title-box">
			<div class="row align-items-center">
				<div class="col-md-8">
					<h4 class="page-title m-0">Update About</h4>
					<span>Other Page / About Us</span>
				</div>
				<div class="col-md-4">
			...
			<div class="card-body">
				<div class="card-body">
					...
					<form action="<?php echo base_url(); ?>Admin/Update_about" method="post" enctype="multipart/form-data">
						<?php
						 foreach ($data['about'] as $key_about => $item_about) {
					 ?>
						<div class="card mb-0">
                       ...
                       <textarea id="elm_<?php echo $item_language['language_title']; ?>" name="content[<?php echo $item_language['language_title']; ?>]" ><?php echo $item_about[$content]; ?>"</textarea>
                     </div>
										</div>
										<?php
											}
