...
<script>
    $(document).ready(function () {
        if($("#elm_v_<?php echo $item_language['language_title']; ?>").length > 0){
            tinymce.init({
                selector: "textarea#elm_v_<?php echo $item_language['language_title']; ?>",
                theme: "modern",
                entity_encoding : "raw",
                height:300,
                plugins: [
...
<script>
    $(document).ready(function () {
        if($("#elm_m_<?php echo $item_language['language_title']; ?>").length > 0){
            tinymce.init({
                selector: "textarea#elm_m_<?php echo $item_language['language_title']; ?>",
                theme: "modern",
                entity_encoding : "raw",
                height:300,
                plugins: [
