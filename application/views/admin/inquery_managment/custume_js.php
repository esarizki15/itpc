...
<script type="text/javascript">
	...
	$(document).ready(function() {
      ...
      "order": [], //Line ini sudah tidak diperlukan
			// Load data dari ajax
			"ajax": {
				"url": "<?php echo base_url()?>index.php/Admin/Inquiry_list_data",
           ...
           return meta.row + meta.settings._iDisplayStart + 1;
				...
				{data: 'inquiry_title', name: 'inquiry_title' },
				{data: 'exporter_name', name: 'exporter_name'},
				...
				{data: 'status', name: 'status'},
				{
					...
					mRender: function (data) {
						 return '<a class="btn btn-info waves-effect waves-light" href="<?php echo base_url()?>Admin/Inquiry_detail/'+ data +'"><i class="fas fa-pencil-alt"></i></a> | \n\
						 <a class="btn btn-danger waves-effect waves-light" href="<?php echo base_url()?>Admin/Inquiry_delete/'+ data +'" onclick="javascript:return confirm(\'Anda yakin?\');"><i class="fas fa-trash-alt"></i></a>';
				 }
			 }
			],
