<!-- DataTables -->
  ...
  <!-- Summernote css -->
  <link href="<?php echo $this->config->item('admin_source'); ?>/plugins/summernote/summernote-bs4.css" rel="stylesheet" />

  <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />

  <!-- ION Slider -->
  <link href="<?php echo $this->config->item('admin_source'); ?>plugins/ion-rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css"/>
