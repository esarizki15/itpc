		...
		<div class="page-title-box">
			<div class="row align-items-center">
				<div class="col-md-8">
					...
					<span>News Management / Add Exporter</span>
				</div>
				<div class="col-md-4">
...
<div class="row">
	<div class="col-12">
		<div class="card m-b-30">
			<div class="card-body">
				<div class="card-body">
					<h4 class="mt-0 header-title">Form Add News</h4>
					<form action="<?php echo base_url(); ?>Admin/Submit_news" method="post" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<center>
													<div class="form-group">
														<img class="m-t-30" id="blah_2" name="header" src="#" alt="your image" style="max-width:300px;max-height:200px;" />
													</div>
													<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												 <input type="text" class="form-control" placeholder="mm/dd/yyyy" name="published_at" id="published_at">
                       ...
                       <textarea id="elm_<?php echo $item_language['language_title']; ?>" name="content[<?php echo $item_language['language_title']; ?>]" ></textarea>
                     </div>
										</div>
										<?php
											}
