	...
	<div class="col-sm-12">
		<div class="page-title-box">
			<div class="row align-items-center">
				<div class="col-md-8">
					<h4 class="page-title m-0">Category Exporter</h4>
					<span>Exporter Management / Category Exporter</span>
				</div>
				<div class="col-md-4">
		...
		<div class="card m-b-30">
			<div class="card-body">
				<div class="card-body">
					...
					<form action="<?php echo base_url(); ?>Admin/Submit_category" method="post" enctype="multipart/form-data">
						<div class="card mb-0">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" name="category_old_id" class="form-control"  placeholder="Type something" />
											</div>
										</div>
										<div class="col-md-8">
											<div class="form-group">
												<label>Title Category<span style="color:red">*</span></label>
												<input type="text" name="category_title" class="form-control" required placeholder="Type something" />
											</div>
										</div>
									</div>
								</div>
